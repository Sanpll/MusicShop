...
2. Красиво оформить вывод информации у администратора
3. Оформить /error

Задачи backend:
1. Сделать нормальный логин, перелогин и выход из аккаунта
2. Сделать /error
3. Сделать постраничную работу с бд (пагинация)
