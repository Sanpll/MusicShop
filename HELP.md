...
Задачи frontend:
1. Сделать header для всех html из customer
2. Сделать /confirmOrder (по сути нужны просто 2 кнопки) (наверное показывать то же самое, что и в таблице, но в столбик)
3. Сделать /newSupply с выбором произвольного количества товаров и их количества
4. Сделать фильтрацию по тегам в home (+сделать кнопку "применить")
5. Проверить в каждом файле используются ли нужные классы
