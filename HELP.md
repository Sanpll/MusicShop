...
Задачи frontend:
1. Сделать /confirmOrder (по сути нужны просто 2 кнопки) (наверное показывать то же самое, что и в таблице, но в столбик)
2. Сделать /newSupply с выбором произвольного количества товаров и их количества
3. Сделать фильтрацию по тегам в home (+сделать кнопку "применить")
4. Проверить в каждом файле используются ли нужные классы
